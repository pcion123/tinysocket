...
public class ProtocolId extends com.vscodelife.socketio.constant.ProtocolId {
    public static final ProtocolKey RELASH_TOKEN = new ProtocolKey(0, 125);
    ...
    public static final ProtocolKey GET_USER_INFO = new ProtocolKey(1, 4);
    public static final ProtocolKey SAY = new ProtocolKey(1, 5);
    public static final ProtocolKey MESSAGE = new ProtocolKey(1, 6);
}

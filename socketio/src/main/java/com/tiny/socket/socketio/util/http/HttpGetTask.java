...
public class HttpGetTask implements Runnable {
    ...
    public HttpGetTask(String url, Map headers, long timeout, Consumer<HttpBaseResponse> finish,
            Consumer<HttpBaseResponse> error, ExecutorService pools) {
        this.timeout = timeout;
        this.task = new Task(url, headers, timeout, finish);
        this.pools = pools;
        this.error = error;
    }
    ...
    private class Task implements Runnable {
        ...
        @SuppressWarnings("rawtypes")
        public Task(String url, Map headers, long timeout, Consumer<HttpBaseResponse> finish) {
            this.url = url;
        ...
        public void run() {
            ...
            try {
                ...
                message = status == HttpStatus.SC_OK ? "success" : "fail";

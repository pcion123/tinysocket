package com.tiny.socket.websocket.connection;
...
public abstract class ConnectionBase {
    ...
    public String toString() {
        return String.format("Version=%d Id=%s SessionId=%d Address=%s ConnectTime=%s",
                getVersion(), getId(), getSessionId(), getAddress(), getConnectTime());
    }
    ...
    public void send(int mainNo, int subNo, String buffer, boolean release) {
        send((byte) mainNo, (byte) subNo, buffer, release);
    }

    protected abstract void send(byte mainNo, byte subNo, String buffer, boolean release);
}
